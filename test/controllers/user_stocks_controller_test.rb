...
class UserStocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_stock" do
    assert_difference('UserStock.count') do
      post user_stocks_url, params: { user_stock: { company_name: @user_stock.company_name, order_quantity: @user_stock.order_quantity, stock_price: @user_stock.stock_price, stock_symbol: @user_stock.stock_symbol, total_stock_price: @user_stock.total_stock_price, user_id: @user_stock.user_id } }
    end
  ...
  test "should update user_stock" do
    patch user_stock_url(@user_stock), params: { user_stock: { company_name: @user_stock.company_name, order_quantity: @user_stock.order_quantity, stock_price: @user_stock.stock_price, stock_symbol: @user_stock.stock_symbol, total_stock_price: @user_stock.total_stock_price, user_id: @user_stock.user_id } }
